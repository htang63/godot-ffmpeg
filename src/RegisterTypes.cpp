...
extern "C" {
	// Initialization.
	GDExtensionBool GDE_EXPORT ffmpeg_library_init(const GDExtensionInterface  *p_interface, const GDExtensionClassLibraryPtr  p_library, GDExtensionInitialization  *r_initialization) {
